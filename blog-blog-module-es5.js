...
var BlockDetaliComponent = /** @class */ (function () {
    function BlockDetaliComponent(blogService, route) {
        this.blogService = blogService;
        this.route = route;
        this.id = +this.route.snapshot.params.id;
    }
    BlockDetaliComponent.prototype.ngOnInit = function () {
        this.getPost();
    };
    BlockDetaliComponent.prototype.getPost = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.blogService.getPostById(this.id)];
                    case 1:
                        _a.post = _b.sent();
                        return [2 /*return*/];
                }
    ...
    BlockDetaliComponent.ctorParameters = function () { return [
...
var BlockListComponent = /** @class */ (function () {
    function BlockListComponent(router, blogService) {
        var _this = this;
        this.router = router;
        this.blogService = blogService;
        this.posts = [];
        this.blogService.setType.subscribe(function (type) {
            _this.type = type;
        });
    }
    ...
    BlockListComponent.prototype.getPost = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.blogService.getPosts()];
                    case 1:
                        _a.posts = _b.sent();
                        return [2 /*return*/];
                }
    ...
    BlockListComponent.prototype.openPost = function (post) {
...
var BlockSelectComponent = /** @class */ (function () {
    function BlockSelectComponent(sectionsService) {
        this.sectionsService = sectionsService;
    }
    BlockSelectComponent.prototype.ngOnInit = function () {
    ...
    BlockSelectComponent.ctorParameters = function () { return [
...
var BlockSelectModel = /** @class */ (function () {
    function BlockSelectModel() {
    }
    return BlockSelectModel;
}());
...
var BlogService = /** @class */ (function () {
    ...
    BlogService.prototype.getPostById = function (id) {
        return this.http.get('assets/db.json').toPromise()
            .then(function (res) {
            return res.posts.find(function (post) {
                return post.id === id;
            });
        });
    };
...
var PostsPipe = /** @class */ (function () {
    function PostsPipe() {
    }
    PostsPipe.prototype.transform = function (value, type) {
        if (!type || type === 'all') {
            return value;
        }
        return value.filter(function (post) {
...
var SectionsService = /** @class */ (function () {
    ...
    SectionsService.prototype.getList = function () {
...
var SectionBlogComponent = /** @class */ (function () {
    function SectionBlogComponent(blogService) {
        this.blogService = blogService;
    }
    SectionBlogComponent.prototype.ngOnInit = function () {
    };
    SectionBlogComponent.prototype.onType = function () {
        this.blogService.setType.next(this.section.type);
        localStorage.setItem('currentPart', this.section.type);
    };
    SectionBlogComponent.ctorParameters = function () { return [
        { type: _blog_service__WEBPACK_IMPORTED_MODULE_3__["BlogService"] }
    ]; };
